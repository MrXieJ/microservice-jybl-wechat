...
public class WxMenuController implements WxMpMenuService {
    ...
    public String menuCreateSample() throws WxErrorException {
        ...
        button31.setUrl("http://mrxiej.ngrok.wendal.cn/Xinyijia/index.html/");
        WxMenuButton button32 = new WxMenuButton();
        button32.setType(WxConsts.BUTTON_VIEW);
        button32.setName("关于心壹家");
        button32.setUrl("http://mrxiej.ngrok.wendal.cn/Xinyijia/index.html/");
        WxMenuButton button33 = new WxMenuButton();
        button33.setType(WxConsts.BUTTON_VIEW);
        button33.setName("联系我们");
        button33.setUrl("http://mrxiej.ngrok.wendal.cn/Xinyijia/index.html/");

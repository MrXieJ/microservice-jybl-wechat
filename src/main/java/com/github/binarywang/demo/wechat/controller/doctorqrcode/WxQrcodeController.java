...
public class WxQrcodeController implements WxMpQrcodeService{
    ...
    * */
    ...
    public String qrCodeCreateLogo(@RequestParam("doctorid")String doctorid,Model model) throws WxErrorException, QRParamsException,IOException {
        String url = wxUrlService.getQrcodeurl()+"/"+doctorid;
        File logo = new File("G:/logo/logo.jpg");
        String qrcodepath="G:/qrcode/doctor"+doctorid+".jpg";
